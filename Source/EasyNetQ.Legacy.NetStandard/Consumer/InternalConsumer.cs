...
namespace EasyNetQ.Consumer
{
	...
	public class InternalConsumer : IBasicConsumer, IInternalConsumer
	{
		...
		private void Cancel()
		{
			...
			ConsumerCancelled(this, new ConsumerEventArgs(Enumerable.Empty<string>().ToArray()));
		}
			...
			ReadOnlyMemory<byte> body)
		{
			...
			var context = new ConsumerExecutionContext(onMessage, messageRecievedInfo, messsageProperties, body.ToArray(), this);
